...
print("Det blir " + str(money_on_hand - ticket_price) + " kronor över.") # omvandla variables to concatenate str()
half_of_money_left = (money_on_hand - ticket_price) / 2 # () aritmetik
